...
public class IntListTest
{
	...
	public static void dispatch(int choice)
	{
		...
		case 7:
			...
			oldVal = scan.nextInt();
			System.out.println("Enter new value to use: ");
			newVal = scan.nextInt();
	...
	public static void printMenu()
	{
		...
		System.out.println("6: remove an integer from back of the list");
		System.out.println("7: Replace old value with new values for all items in the list");
